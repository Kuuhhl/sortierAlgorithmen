...
def main(unsortiert):
    ...
    # Original-Kopie herstellen:
    unsortiertOriginal = unsortiert.copy()
    # Duplikate entfernen:
    unsortiert = list(set(unsortiert))
    # Liste der entfernten Einträge herstellen:
    entferntListe = list((Counter(unsortiertOriginal) - Counter(unsortiert)).elements())
    ...
    # Duplikate wieder einfügen:
    for item in entferntListe:
        sortiert.insert(sortiert.index(item), item)
